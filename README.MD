...
- Quizes are now fully functional within `SayTVChatHeaderView`
- Mentions now work within the `SayTVChatView` component
...
```
implementation 'org.bitbucket.square1.saytv_sdk_android:release:1.0.0-alpha04'
```
4. You're all set!
