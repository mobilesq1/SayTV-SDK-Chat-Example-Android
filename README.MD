...
```kotlin
binding.chatView.commentsView.apply {
...
```kotlin
binding.chatView.commentsView.customizeTheme {
...
4. `SayTVChatView.init()` has been called with the proper parameters, see `SayTVChatView.init()`
